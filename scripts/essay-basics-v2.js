/* =========================================================================
   서술형 훈련 — 기초 기르기 (essay-basics) · 레이아웃 v2
   좌우 2분할 → 세로 단일 스크롤(문제 위 · 풀이 아래). 문제 카드는 열고 접기 +
   스크롤 시 상단 스티키. 빈칸/팝오버/채점/결과 동작은 essay-basics.js 와 동일.
...
(function () {
  ...
  // v2: 스크롤 컨테이너가 .stage-scroll 로 바뀜 (기존 #expl 자체 스크롤 → 단일 스크롤)
